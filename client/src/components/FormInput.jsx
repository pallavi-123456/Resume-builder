...
const FormInput = forwardRef(({ label, error, className, ...rest }, ref) => {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ref={ref}
        className={clsx(
          "rounded-xl border bg-paper-card px-4 py-2.5 text-sm text-ink500 outline-none transition-colors placeholder:text-ink500/40",
